<template>
  <v-app-bar color="#00228f" height="fit-content" absolute>
    <v-container fluid>
      <v-row>
        <v-col cols="3">
        ...
        <v-col cols="5">
          <div>
            <input
              ...
              style="width: 95%; outline: none; border-radius: 300px"
        ...
        <v-col cols="4" class="d-flex justify-space-around">
          <div class="aviliable">
            ...
            <br />
            <strong>88 156 05 22</strong>
          </div>
          <div class="wishlist d-flex flex-column align-center cursor-pointer">
            <span>
              <svg
        ...
        <v-row class="mt-6 pb-2">
          <v-col cols="7">
            <ul
              class="lnks d-flex justify-space-between align-center pt-1 ps-2"
              style="list-style: none"
            >
              <li
                class="cursor-pointer"
                v-for="categ in store.categories"
                :key="categ.title"
              >
                <router-link
                  ...
                  :to="{
                    name: 'product',
                    params: { category: categ.route },
                    query: { title: categ.title },
                  }"
                >
                  {{ categ.title }}
                </router-link>
          ...
          <v-col
            ...
            style="gap: 35px"
          >
            <div class="d-flex align-center cursor-pointer" style="gap: 10px">
              <svg
                style="width: 28px"
                aria-hidden="true"
                focusable="false"
            ...
            <div
              class="lang d-flex align-center cursor-pointer"
              style="gap: 10px"
            >
              <v-btn>
...
const changeDrawer = inject("changeDrawer");
</script>
