    ...
    <v-container>
      <v-row>
        <v-col cols="4" class="d-flex align-center">
          <div class="feature d-flex justify-center align-center">
            <span>
              <svg
                style="width: 40px"
            ...
            <h4 class="feature_text">Free Shipping & Returns</h4>
          </div>
        </v-col>
        <v-col cols="4">
          <div class="feature d-flex justify-center align-center">
            ...
            <h4 class="feature_text">Lowest Price Guarante</h4>
          </div>
        </v-col>
        <v-col cols="4">
          <div class="feature d-flex justify-center align-center">
            ...
            <h4 class="feature_text">Longest Warranties Offer</h4>
          </div>
        </v-col>
      </v-row>
    </v-container>
